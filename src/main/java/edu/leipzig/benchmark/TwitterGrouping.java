...
public class TwitterGrouping {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
         ...
         here for example, set idle state retention time: min = 12 hours, max = 24 hours
        * */
        StreamGraphConfig streamGraphConfig = new StreamGraphConfig(env, 12, 24);
